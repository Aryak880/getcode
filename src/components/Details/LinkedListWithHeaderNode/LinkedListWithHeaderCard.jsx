...
import linkedList from './LinkedListWithHeaderFunctions';
import Boiler from './LinkedListWithHeaderboiler';
  ...
  render() {
    return (
      <div>
        ...
        <br />
        <div className="functionHeading"><h2>Linked list with header node functions</h2></div>
