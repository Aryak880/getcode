...
import Fun from './queueUsingCircularLinkedListFunctions';
import Boiler from './queueUsingCircularLinkedListboiler';
  ...
  render() {
    return (
      <div>
        ...
        <br />
        <div className="functionHeading"><h2>Queue using circular linked list functions</h2></div>
